...
public class RightOuterJoin {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RightOuterJoin.class);
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Right outer Join of customerIdGenderKV  and customerIdScoreKV PCollection");
        Join.rightOuterJoin(customerIdGenderKV, customerIdScoreKV, "others")
