 ...
 */
public final class InnerJoinBeam {

    private static final Logger LOGGER = LoggerFactory.getLogger(InnerJoinBeam.class);
    ...
    public static void main(String[] args) {
        ...
        PCollection<KV<String, Integer>> customerIdScoreKV = pipeline.apply("ReadingMallCustomersScores", TextIO.read()
